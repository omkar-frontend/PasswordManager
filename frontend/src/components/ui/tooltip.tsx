  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 w-fit max-w-xs origin-(--radix-tooltip-content-transform-origin) rounded-lg border border-hairline bg-surface-2 px-2.5 py-1.5 text-xs text-balance text-theme-text shadow-xl shadow-black/40",
